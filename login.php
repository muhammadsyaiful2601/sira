...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        $stmt = mysqli_prepare($conn, "SELECT id, nama, password, role FROM users WHERE email = ? AND status = 'aktif'");
...
<head>
    ...
    <!-- Google Fonts: Poppins (sama dengan style.css) -->
...
<body>
    <div class="login-wrapper">
        <div class="login-card">
            <div class="logo-area">
                <!-- Ganti dengan logo rumah sakit Anda -->
                <img src="asset/image/icon/1.png" alt="Logo Rumah Sakit" class="hospital-logo" onerror="this.onerror=null; this.src='https://placehold.co/90x90?text=RS'">
                <h1 class="app-title">Login SIRA</span></h1>
