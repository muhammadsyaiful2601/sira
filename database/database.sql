...
-- Tabel users (tambah kolom no_hp, alamat)
...
-- Tabel lamaran (tambah kolom untuk verifikasi dan interview)
...
-- Tambahkan kolom untuk jadwal interview dan catatan pimpinan
ALTER TABLE lamaran 
ADD COLUMN jadwal_interview DATETIME NULL AFTER status_lamaran,
ADD COLUMN catatan_pimpinan TEXT NULL AFTER jadwal_interview;
